...
class LocationConsumer(threading.Thread):
    ...
    Based on kafka-python examples @ https://github.com/dpkp/kafka-python/blob/master/example.py
    """
    ...
    def run(self):
        ...
        consumer = KafkaConsumer(bootstrap_servers=self.kafka_server, consumer_timeout_ms=1000,
